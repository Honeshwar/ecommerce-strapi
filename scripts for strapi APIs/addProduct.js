...
const products = [
  ...
  // {
  //   title: "Evening Clutch",
  //   desc: "This elegant evening clutch is designed to complement your party and formal outfits. Featuring a sleek black finish, it adds a refined touch to your overall look. The compact interior provides enough space for essentials like phone, cards, and makeup. Lightweight and easy to carry, it is perfect for weddings, parties, and special occasions. Crafted with quality materials, this clutch offers durability while maintaining a stylish and luxurious appearance.",
  //   price: 1899,
  //   oldPrice: 2199,
  //   isNew: false,
  //   type: "featured",
